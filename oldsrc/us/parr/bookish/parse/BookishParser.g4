 ...
 *  \pyfig[width="20em"]{...}
 *  \pyfig[label]{...}
codeblock_args returns [Map<String,String> attributes = new LinkedHashMap<>()]
	:	START_CODE_BLOCK_ARGS
		(	l=CODE_BLOCK_ATTR CODE_BLOCK_COMMA
			codeblock_arglist[$attributes] ( CODE_BLOCK_COMMA codeblock_arglist[$attributes] )*
			{$attributes.put("label", $l.text.trim());}
...
codeblock_arglist[Map<String,String> attributes]
